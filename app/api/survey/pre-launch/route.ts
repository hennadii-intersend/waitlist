...
export async function POST(request: Request) {
  try {
    ...
    const dataToInsert = {
      ...
      agreement_manage_accounts: surveyData.agreementManageAccounts,
      biggest_frustrations: surveyData.biggestFrustrations,
      regular_apps: surveyData.regularApps,
      manage_app_access: surveyData.manageAppAccess,
      feature_rank_1: surveyData.featureRanking?.rank1,
      feature_rank_2: surveyData.featureRanking?.rank2,
      feature_rank_3: surveyData.featureRanking?.rank3,
      feature_suggest_other: surveyData.featureRanking?.suggestOther,
      automated_transaction_frequency: surveyData.automatedTransactionFrequency,
